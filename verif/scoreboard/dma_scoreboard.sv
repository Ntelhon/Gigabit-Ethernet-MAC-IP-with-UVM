...
class dma_scoreboard extends uvm_scoreboard;
    ...
    uvm_analysis_export #(axi_stream_item) axis_tx_export;  // TX to MAC
    uvm_analysis_export #(axi_stream_item) axis_rx_export;  // RX from MAC
    ...
    uvm_tlm_analysis_fifo #(axi_stream_item) axis_tx_fifo;
    uvm_tlm_analysis_fifo #(axi_stream_item) axis_rx_fifo;
