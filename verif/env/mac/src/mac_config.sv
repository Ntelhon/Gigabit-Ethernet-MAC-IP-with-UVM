...
class mac_config extends uvm_object;
  ...
  `uvm_object_utils_begin(mac_config)
    ...
    `uvm_field_object(gmii_phy_cfg, UVM_DEFAULT)
  ...
  function new(string name = "mac_config");
    ...
    gmii_phy_cfg = gmii_config::type_id::create("gmii_phy_cfg");
    gmii_phy_cfg.direction = GMII_RX;
    gmii_phy_cfg.is_active = UVM_ACTIVE;  // Drive packets into MAC
  endfunction
