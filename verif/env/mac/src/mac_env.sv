...
class mac_env extends uvm_env;
  ...
  // Agents
  axi_stream_agent#(32,1,1,1) tx_stream_agent;  // MAC → DMA
  axi_stream_agent#(32,1,1,1) rx_stream_agent;  // DMA → MAC
  ...
  function void build_phase(uvm_phase phase);
    ...
    tx_stream_agent = axi_stream_agent#(32,1,1,1)::type_id::create("tx_stream_agent", this);
    rx_stream_agent = axi_stream_agent#(32,1,1,1)::type_id::create("rx_stream_agent", this);
