...
class dma_stress_test extends dma_base_test;
    ...
    virtual task tx_stress_traffic();
        ...
        while (tx_queued < num_tx_packets) begin
            ...
            read_reg(32'h021C, head);
            read_reg(32'h0220, tail);
            
            // Calculate available space
            available = (head > tail) ? (head - tail - 1) : (desc_count - tail + head - 1);
            ...
            if (available > 0) begin
                ...
                begin
                    bit [15:0] pkt_id = tx_queued;
                    pkt_data[20] = pkt_id[7:0];
                    pkt_data[21] = pkt_id[15:8];
                end
    ...
    virtual task monitor_progress();
        ...
        while (timeout > 0) begin
            ...
            read_reg(32'h021C, tx_head);
            read_reg(32'h024C, rx_head);
    ...
    virtual task report_results();
        ...
        read_reg(32'h0260, tx_pkt_cnt);
        read_reg(32'h0264, tx_byte_cnt);
        read_reg(32'h0270, rx_pkt_cnt);
        read_reg(32'h0274, rx_byte_cnt);
