...
class eth_controller_full_test extends dma_base_test;
    ...
    virtual task test_mac_configuration();
        ...
        // Set MAC address
        write_reg(32'h0010, dut_mac_address[31:0]);
        write_reg(32'h0014, {16'h0, dut_mac_address[47:32]});
        
        // Verify readback
        read_reg(32'h0010, data);
        ...
        write_reg(32'h0000, 32'h0000_0003);  // TX_EN | RX_EN
        
        // Verify
        read_reg(32'h0000, data);
        ...
        write_reg(32'h0004, 32'h0000_0001);  // PROMISC
    ...
    virtual task test_dma_configuration();
        ...
        write_reg(32'h0280, 32'h0064_0002);  // TX: 2 packets or 100 cycles
        write_reg(32'h0284, 32'h0064_0002);  // RX: 2 packets or 100 cycles
    ...
    virtual task test_interrupts();
        ...
        begin
            ...
            read_reg(32'h0220, tail);
            queue_tx_packet(pkt, tail);
            write_reg(32'h0220, (tail + 1) % desc_count);
            total_tx_packets++;
        end
    ...
    virtual task test_error_handling();
        ...
        read_reg(32'h0008, status);  // MAC IRQ status
    ...
    virtual task test_statistics();
        ...
        // Read MAC statistics
        read_reg(32'h0020, mac_tx_frames);  // TX frame count
        read_reg(32'h0030, mac_rx_frames);  // RX frame count
        
        // Read DMA statistics
        read_reg(32'h0260, dma_tx_pkts);
        read_reg(32'h0264, dma_tx_bytes);
        read_reg(32'h0270, dma_rx_pkts);
        read_reg(32'h0274, dma_rx_bytes);
